  ...
  return (
    <div className="fixed z-[500] top-0 left-0 flex justify-center items-center bg-[#000]
      h-full w-full px-2.5">
        <div className="relative px-3 w-full sm:w-3/5 h-[92%] sm:h-[85%] bg-white rounded-lg">
      ...
      {/* CIRCLE DESIGN */}
      <div className="border-[#014E9A] absolute -top-5 -right-[100px] sm:-top-10 sm:-right-[150px] opacity-10
      border-[60px] rounded-full  h-[200px] w-[200px] sm:h-[300px] sm:w-[300px]" />

    <div className="border-[#014E9A] absolute -bottom-10 -left-[150px] opacity-10
